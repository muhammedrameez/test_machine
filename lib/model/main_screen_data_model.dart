class HomeScreenDetailsModel {
  int count;
  String next;
  String previous;
  List<Results> results;

  HomeScreenDetailsModel({this.count, this.next, this.previous, this.results});

  HomeScreenDetailsModel.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
